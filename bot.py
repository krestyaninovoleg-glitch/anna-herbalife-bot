...
TOKEN: Final[str] = os.getenv("TELEGRAM_BOT_TOKEN", "8539857651:AAEZONa579W_JtU_tR2BV4CRS6AI52P4ueQ")
...
INSTAGRAM_LINK: Final[str] = "https://instagram.com/anna__yakubenko_"
...
async def lead_note(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if ADMIN_CHAT_ID and "PASTE_YOUR" not in ADMIN_CHAT_ID:
        try:
...
def validate() -> None:
    if "PASTE_YOUR_BOT_TOKEN_HERE" in TOKEN:
        raise RuntimeError("Вставьте токен бота в переменную TELEGRAM_BOT_TOKEN.")
    ensure_csv()
